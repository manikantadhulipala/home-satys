        ...
        <div class="form-group">
          ...
          <div class="col-sm-8">
           ...
           <div class="col-sm-6">
            <div class="form-group">
              <div class="row">
                <div class="control-label col-sm-5"><h4>Homestay Type:</h4></div>
                  <div class="col-sm-7">
                <select class="form-control" name="room_type"required>
                  <option>Hill View Homestay</option>
                  <option>Evergreen Estate Homestay</option>
                  <option>Summer Hill Homestay</option>
                  <option>Suite Room Homestay</option>
                  <option>Happy Valley Homestay</option>
               </select>
              </div>
              </div>
            </div>
            ...
            <div class="form-group">
              <div class="row">
                ...
                <div class="col-sm-7">
                  ...
                  <div class="radio-inline"><input type="radio" value="dubble" name="Occupancy" required>Triple</div>
                </div> 
              </div>
            </div>
