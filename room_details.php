...
<body style="margin-top:50px;">
  ...
  <div class="carousel-inner">
    <div class="item active">
      <img src="image/image gallery/g1.jpg"class="thumbnail" alt="img1">
    </div>

    <div class="item">
      <img src="image/image gallery/g2.jpg"class="thumbnail" alt="im2">
    </div>

    <div class="item">
       <img src="image/image gallery/g3.jpg"class="thumbnail" alt="im3">
    </div>

    <div class="item">
       <img src="image/image gallery/g4.jpg"class="thumbnail" alt="img4">
    </div>

    <div class="item">
       <img src="image/image gallery/g5.jpg"class="thumbnail" alt="img5">
    </div>

    <div class="item">
       <img src="image/image gallery/7.jpg"class="thumbnail" alt="img7">
    </div>
  </div>
