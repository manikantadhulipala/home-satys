...
<body style="margin-top:50px;">
  ...
  <a class="right carousel-control" href="#myCarousel" data-slide="next">
    ...
    <span class="sr-only">Next</span>
		...
		<p class="text-justify">The Contemporary  designed twin bedded rooms are well equipped with modern amenities. Fresh Decor and refined ambiance is the winning combination to make these rooms an ideal choice for discerning business traveler.</p>
    <div class="row">
      <h2>Amenities</h2>
