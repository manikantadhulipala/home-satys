<script>
	function delRoom(id)
	{
		if(confirm("You want to delete this homestay?"))
		{
...
<table class="table table-bordered table-striped table-hover">
	<h1>Homestay Details</h1><hr>
	<tr>
	<td colspan="8"><a href="dashboard.php?option=add_rooms" class="btn btn-primary">Add New Homestays</a></td>
	</tr>
	<tr style="height:40">
		<th>Sr No</th>
		<th>Image</th>
